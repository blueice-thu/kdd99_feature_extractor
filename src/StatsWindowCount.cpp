...
namespace FeatureExtractor {
    ...
    StatsWindowCount<TStatsPerHost, TStatsPerService>::StatsWindowCount(unsigned int window_size)
            : StatsWindow<TStatsPerHost, TStatsPerService>(new FeatureUpdaterCount()), window_size(window_size) {
    }
    ...
    template
    class StatsWindowCount<StatsPerHost, StatsPerService>;

    template
    class StatsWindowCount<StatsPerHost, StatsPerServiceWithSrcPort>;
}
