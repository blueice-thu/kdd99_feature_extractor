...
namespace FeatureExtractor {
    ...
    StatsWindowTime<TStatsPerHost, TStatsPerService>::StatsWindowTime(unsigned int window_size_ms)
            : StatsWindow<TStatsPerHost, TStatsPerService>(new FeatureUpdaterTime()), window_size_ms(window_size_ms) {
    }
    ...
    template
    class StatsWindowTime<StatsPerHost, StatsPerService>;

    template
    class StatsWindowTime<StatsPerHost, StatsPerServiceWithSrcPort>;
}
